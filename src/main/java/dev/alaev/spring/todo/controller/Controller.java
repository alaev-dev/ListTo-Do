...
public class Controller {
  ...
  public String saveDocket(
      @Valid @ModelAttribute("docketInput") DocketInput docketInput,
    ...
    service.saveDocket(
        new Docket(
            ...
            docketInput.getDeadline().length() > 0
                ? LocalDateTime.parse(docketInput.getDeadline(), FORMATTER)
                : null,
            null,
            null,
            pickedTag));
  ...
  public String updateDocket(@RequestParam("docketId") long id, Model model) {
    ...
    model.addAttribute(
        ...
        new DocketInput(
            ...
            docket.getDeadlineLDT() == null ? "" : docket.getDeadlineLDT().format(FORMATTER),
            "",
            pickedTags));
    model.addAttribute("listOfTag", getListOfTag());
